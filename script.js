...
class GoalPulse {
        ...
        card.innerHTML = `
            ...
            <div class="goal-header">
                ...
                <div class="goal-actions">
                    ...
                    <button class="btn btn-secondary btn-sm edit-goal-btn" data-goal-id="${goal.id}" title="Edit Goal">

                        ✏️

                    </button>

                    <button class="btn btn-danger btn-sm delete-goal-btn" data-goal-id="${goal.id}" title="Delete Goal">
    ...
    showAddGoalModal() {
        ...
        const modalTitle = document.querySelector('#addGoalModal h3');
    ...
    handleGoalSubmit() {
        ...
        if (this.editingGoalId) {
            ...
            // Check for duplicate titles when adding new goal
...
document.addEventListener('DOMContentLoaded', () => {
    const addGoalBtn = document.getElementById('addGoalBtnMain');
    if (addGoalBtn) {
        addGoalBtn.addEventListener('click', () => {
            streakaura.showAddGoalModal();
        });
    }
});
...
// Test function for add goal button
window.testAddGoal = () => {
    console.log('Testing add goal modal...');
    if (streakaura && streakaura.showAddGoalModal) {
        streakaura.showAddGoalModal();
        console.log('✅ Add goal modal should be open now');
    } else {
        console.log('❌ streakaura or showAddGoalModal not found');
    }
};
